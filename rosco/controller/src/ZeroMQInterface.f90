...
CONTAINS
    SUBROUTINE UpdateZeroMQ(LocalVar, CntrPar, ErrVar)
        ...
        real(C_DOUBLE) :: turbine_measurements(38)
        ...
        IF ( MOD(LocalVar%n_DT, CntrPar%n_DT_ZMQ) == 0 .OR. LocalVar%iStatus == -1 ) THEN
            ...
            turbine_measurements(18) = LocalVar%PtfmTDX
            turbine_measurements(19) = LocalVar%PtfmTDY
            turbine_measurements(20) = LocalVar%PtfmTDZ
            turbine_measurements(21) = LocalVar%PtfmRDX
            turbine_measurements(22) = LocalVar%PtfmRDY
            turbine_measurements(23) = LocalVar%PtfmRDZ
            turbine_measurements(24) = LocalVar%PtfmTVX
            turbine_measurements(25) = LocalVar%PtfmTVY
            turbine_measurements(26) = LocalVar%PtfmTVZ
            turbine_measurements(27) = LocalVar%PtfmRVX
            turbine_measurements(28) = LocalVar%PtfmRVY
            turbine_measurements(29) = LocalVar%PtfmRVZ
            turbine_measurements(30) = LocalVar%PtfmTAX
            turbine_measurements(31) = LocalVar%PtfmTAY
            turbine_measurements(32) = LocalVar%PtfmTAZ
            turbine_measurements(33) = LocalVar%PtfmRAX
            turbine_measurements(34) = LocalVar%PtfmRAY
            turbine_measurements(35) = LocalVar%PtfmRAZ
            turbine_measurements(36) = LocalVar%BlPitchCMeas
            turbine_measurements(37) = LocalVar%BlPitch(3)
            turbine_measurements(38) = LocalVar%WE_Vw
